    ...
    <div className=' mt-12'>
      ...
      <div className=' flex flex-wrap lg:flex-nowrap justify-center'>
        <div className=' bg-white dark:bg-secondary-dark-bg h-44 rounded-xl w-full lg:w-80 p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-center'>
          ...
          <div className=' mt-6'>
            <Button text="Download" color="white" bgColor={currentColor} borderRadius="10px" size="md"></Button>
          </div>
        </div>
      ...
      <div className=' flex gap-10 flex-wrap justify-center'>
        <div className=' bg-white dark:bg-secondary-dark-bg m-3 rounded-2xl md:w-780 p-3'>
