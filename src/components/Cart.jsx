...
const Cart = () => {
  ...
  return (
    <div className=' w-full fixed nav-item top-0 right-0 bg-half-transparent'>
      <div className=' float-right h-screen overflow-y-auto duration-1000 ease-in-out dark:text-gray-200 transition-all dark:bg-[#484b52] bg-white md:w-400 p-8'>
        <div className=' flex justify-between items-center'>
          ...
          <button onClick={()=>setIsClicked(initialState)} type="button" style={{color:'rgb(153,171,180',borderRadius:"50%"}} className=' text-2xl hover:drop-shadow-xl p-3 hover:bg-light-gray'>
            ...
            <div key={index}>
              <div>
                <div className=' flex items-center leading-8 gap-5 border-b-1 border-color dark:border-gray-600 p-4'>
                    <img className=' rounded-lg h-80 w-24 object-cover' src={item.image}></img>
                    <div>
